...
import type { KpiMetric, NavItem, Order } from './types';

export const navItems: NavItem[] = [
  { label: 'Dashboard', href: '../dashboard/index.html', icon: LayoutDashboard },
  ...
  { label: 'Website Builder', href: '#/builder', icon: Globe },
];
